...
config:
  -
    ...
    list:
      -
        title: 查找
        description: 可以点击顶栏左侧的搜索栏或者使用快捷键 ``ctrl + K`` 进行笔记内容的搜索. 因为是本地搜索，所以速度可能会有一些慢，请见谅.
      -
        title: 评论
        description: 已经配置了 Twikoo 评论系统，评论的回复会用邮件进行通知，请及时查收；同时欢迎发表观点.
      - 
        title: 笔记
        description: 点击 <a href='/cloudinwindblog/notes/'>此处</a> 进入笔记，或者从顶部导航栏进入笔记.
      -
        title: 博客
        description: 点击 <a href='/cloudinwindblog/blog/'>此处</a> 进入 blog 文章页面.
      -
        title: ⌈ 开往 ⌋
